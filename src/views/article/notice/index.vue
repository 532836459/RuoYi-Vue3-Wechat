  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['article:notice:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['article:notice:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['article:notice:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['article:notice:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['article:notice:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="浏览量" prop="view">
              <el-input-number v-model="form.view" :min="1"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="状态" prop="commonStatus">
...
import { listNotice, getNotice, delNotice, addNotice, updateNotice } from "@/api/article/notice";
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除通知公告编号为"' + _ids + '"的数据项？').then(function() {
...
function handleExport() {
  proxy.download('article/notice/export', {
    ...queryParams.value
